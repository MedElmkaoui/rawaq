  ...
  return (
    <div className="my-12">
      <div className="flex flex-col items-center space-y-5">
        ...
        <p className="text-xl text-center text-gray w-[85%] xl:w-[50%]">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى.</p>
      </div>
      <div className="flex flex-col xl:flex-row justify-center items-center gap-12">
        ...
        <div className="w-[250px] xl:mt-24 rounded-3xl p-5 flex flex-col items-center justify-center shadow-xl space-y-8">
